...
<div id="main">
    <div id="contents">
		<table>
		<td bgcolor="#24BDE2" height="35px" style="padding-left: 10px;color:#fff"> Video</td>
			<tr>
				
				<td width><iframe width="100" height="100" src="https://www.youtube.com/embed/95ahbau-rJk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
				<td><iframe width="100" height="100" src="https://www.youtube.com/embed/95ahbau-rJk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
			</tr>
		</table>
	</div>
	<div id="footer">
        <div class="adv_footer">
            ...
            <div class="gop-y"><a target="_blank" href="https://www.facebook.com/nguyen.trungty.3"><img title="Mọi ý kiến của bạn sẽ được trả lời qua facebook" src="image/giaodien/gopy0000.jpg" border="0"></a>
            </div>
        </div>
	</div>
</div>
