		...
		<div class="block-fluid">                         
			...
			<div class="row-form">
				<table width="348" border="0">
					<tr>
						<td width="127px"><input class="btn btn-large" type="submit" value="Thêm vô" name="ok"></td>
						<td width="8">&nbsp;</td>
			...
			<div class="row-form">
				<table width="348" border="0">
					<tr>
						...
						<td width="8">&nbsp;</td>
						<td width="127"><input class="btn btn-large" type="submit" value="Xóa" onClick="return confirm(xong);" name="no"></td>
					</tr>
				</table>
				<div class="clear"></div>
			</div>
