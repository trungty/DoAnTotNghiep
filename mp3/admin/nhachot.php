...
<?php
	...
	{	$sql1=mysqli_query($link,"select * from baihathot");
		...
		if($_POST['ok'])
		{
			...
			if($file_type==true)
			{
				...
				{
					$flag=true;
					$update=mysqli_query($link,"insert into baihathot(tenbaihat,casy,theloai,duongdan) values('$tenbaihat','$casy','$theloai','$dest')");
					if($update)
					{
						echo "Ok. Da Xong!";
					}
		...
		<div class="block-fluid">                        
			...
			<div class="row-form">
				<table width="348" border="0">
					<tr>
						<td width="127px"><input class="btn btn-large" type="submit" value="Nghe" name="ok"></td>
						<td width="8">&nbsp;</td>
						<td width="127"><input class="btn btn-large" type="reset" value="Nhập lại" onClick="return confirm(Làm lại);"></td>
					</tr>
				</table>
				<div class="clear"></div>
			</div>
...
<?php 
	if($_POST['sua'])	
	{
		...
		if($checkbox=='')
		{
			echo '<script type="text/javascript"> alert("Chua chon check box!"); </script>';
		}
		else
		{
			$s_id=implode(", ", $checkbox);
			$update= mysqli_query($link,"update baihathot set tenbaihat='$tenbaihat', casy='$casy', theloai='$theloai' where id IN ($s_id)");
	...
	if($_POST['no'])
		{
			...
			else
			{
				...
				mysqli_query($link,"DELETE FROM baihathot WHERE id IN($del_id)");
			...
			<div class="block-fluid table-sorting">
				<form method="post" action="">
					<table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable">
						...
						<tbody>
							<?php
								$sql=mysqli_query($link,"select * from baihathot");
...
window.onload = externalLinks;
					...
					<table width="348" border="0">
						<tr>
                            <td width="127"><input class="btn btn-large" type="submit" value="Xóa" onClick="return confirm(Xóa);" name="no" ></td>
							<td width="127px"><input class="btn btn-large" type="submit" value="Sửa" onClick="return confirm(Sửa);" name="sua"></td>
							<td width="8">&nbsp;</td>
