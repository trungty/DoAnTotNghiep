...
<?php
	...
	else
	{
		...
		else
		{
			...
			$resual=mysqli_query($link,$sql) or die(mysqli_error());
				if($resual)
				{
...
function check_form()
{
	...
	
	{
		...
		loiuser.innerHTML="Tài khoản không được bỏ trống !"; 
	...
	
	{
		...
		loimk.innerHTML="Chưa nhập mật khẩu !"; 
	...
	if(pass.length<6) 
		{			
			...
			loimk.innerHTML="Mật khẩu phải nhiều hơn 5 kí tự !"; 
